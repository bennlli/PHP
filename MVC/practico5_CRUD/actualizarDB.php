...
<body>
    ...
    echo '<h3>Datos de actualización: </h3>';
    ...
    ?>
    <a href="http://localhost/VSCODE_git/PHP/MVC/nba_CRUD/actualizar.php">Actualizar registro</a>
    <a href="http://localhost/VSCODE_git/PHP/MVC/nba_CRUD/actualizar.php">Borrar registro</a>
    <br>
    <hr>
</body>
</html>