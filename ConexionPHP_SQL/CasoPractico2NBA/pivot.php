...
<body>
    ...
    ?>
    <h1>Resultados obtenidos de los pivots</h1>
    <?php 
    # Consulta de la base de datos.
    $consulta = $mysqli->query('SELECT `Nombre`, `Posicion`, `Nombre_equipo` FROM `jugadores` WHERE Posicion="C"');
    ...
    echo 'El número de resultados de la base de datos es '.$consulta->num_rows.' elementos<br><br>';
        ...
        for ($i=0; $i <$consulta->num_rows ; $i++) { 
            ...
            echo 'El jugador <b>'.$fila['Nombre'].'</b> de "<b>'.$fila['Nombre_equipo'].'</b>", es pivot <b>"'.$fila['Posicion'].'"</b><br>';
        }
    ?>
</body>
</html>